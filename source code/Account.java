...
public static Account account; // variable name with same object
...
public static Account getAccount(Person p) {   // if you pass person name it will get the name
    if (account == null) {
        account = new Account();
    }
    Account.person = p;
...
public synchronized void withdraw(int bal) {   // can process once until it done
    try {
